"""
Train a character-level GPT on Andrew Chiles Guardian article titles.
...
with open("generated.txt", "w", encoding="utf-8") as f:
    f.write("# Generated Andrew Chiles-style Guardian titles\n")
    f.write(f"# microgpt: {n_layer}L / {n_embd}d / {block_size} ctx / {num_steps} steps\n\n")
